...
class AudioManager: ObservableObject {
    ...
    func processAudio(){
        ...
        Timer.scheduledTimer(withTimeInterval: timeInterval, repeats: true) { [self] _ in
            ...
            if(onlyPeaks == true) {spectrum = spectralEnhancer.enhance(inputArray: spectrum) }

            if( showMSPF == true ) { averageTime = monitorPerformance() }
    ...
    func monitorPerformance() -> Double {
        endTime = Date()
