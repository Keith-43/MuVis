...
// option0  TriOct MuSpectrum   Lissajous                   red
// option1  TriOct MuSpectrum
// option2  TriOct MuSpectrum   Lissajous                   blue
// option3  TriOct MuSpectrum   Lissajous(half-amplitude)   red
// option4  plain               Lissajous                   red
// option5  plain               Lissajous                   green
// option6  plain               Lissajous                   blue
// option7  plain               Lissajous(half-amplitude)   red
//
...
struct Harmonograph: View {
    ...
    var body: some View {
        ...
        ZStack {
            if( option < 4 )  { Harmonograph_DoubleSpectrum() }
            if( option != 1 ) { LissajousFigure() }
        }
    }
}

#Preview("Harmonograph") {
    Harmonograph()
        .enhancedPreview()
}
...
// ------------------------------------------------------------------------------------------------------------
            ...
            .foregroundColor(   ( option==2 || option==6 ) ?
                                .init(red: 0.0, green: 0.0, blue: 1.0, opacity: 1.0) :  // foreground color = blue
                                ( option==5) ?
                                .init(red: 0.0, green: 1.0, blue: 0.0, opacity: 1.0) :  // foreground color = green
                                .init(red: 1.0, green: 0.0, blue: 0.0, opacity: 1.0) )  // foreground color = red
